...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    private static final List<ItemLike> galsite_smeltables = List.of(
            Moditems.galsite.get(),
            ModBlocks.GALSITE_ORE.get(),
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        oreSmelting(pWriter, galsite_smeltables, RecipeCategory.MISC, Moditems.hexite_crystal.get(),0.25f, 200, "galsite");
        oreBlasting(pWriter, galsite_smeltables, RecipeCategory.MISC, Moditems.hexite_crystal.get(),0.25f, 100, "galsite");
